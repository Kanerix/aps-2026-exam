...
Bob has recently been renovating his house, and he has finally gotten around to
...
the amount of water the toilet could discharge.

Bob had found documentation on how the pipes were installed and realized it
resembled a series of tubes. This meant that a pipe would connect to a manifold,
which would then distribute the water into different pipes, as this allowed for
increased water flow. To figure this out, Bob has asked you to help determine
which pipe can carry the most water to the sewer.
...
$2<=t<=250$, $s_1!=t$ and $s_2!=t$. What follows is $m$ lines containing 3 integers
$2<=v<=250$, $2<=u<=250$, $v!=u$, and $1<=c<=10^3$, indicating a pipe from
manifold $v$ to manifold $u$ with a capacity of $c$.
